    ...
    return (
      <div className="Application">
        ...
        <section className="message-input">
          ...
          <aside>
            <button disabled={this.state.disabled} className="submit-btn" onClick={() => this.addNewMessage()}> Submit </button>
            <button disabled={this.state.disabled} className="clear-btn" onClick={()=> {this.setState({draftMsg: ''})} }> Clear </button>
          </aside>
        </section>
      </div>
