  ...
  render() {
    ...
    return (
      <div className="Application">
        ...
        <UserList activeUsers={ activeUsers } user={user} selectUser={ this.selectUser.bind(this) } selectedUser={ selectedUser } />
        <MessageInputs user={ user } updateDraftMsg={ this.updateDraftMsg.bind(this) } draftMsg={ draftMsg } addNewMessage={ this.addNewMessage.bind(this) } logOut={this.logOut.bind(this)} />
      </div>
    )
  }
}
